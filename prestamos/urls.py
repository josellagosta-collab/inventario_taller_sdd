...
urlpatterns = [
    ...
    path("prestamos/historico/", views.historico_prestamos, name="historico_prestamos"),
    ...
    path("prestamos/exportar/csv/", views.exportar_prestamos_csv, name="exportar_prestamos_csv"),
    ...
    path("reservas/exportar/csv/", views.exportar_reservas_csv, name="exportar_reservas_csv"),
